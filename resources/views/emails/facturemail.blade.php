                      ...
                      <tr>
                        <td style="text-align: left;">
                          <span class="important-font">
                            {{$facture->civilite}} {{$facture->prenom}} {{$facture->name}} <br>
                          </span>
                          {{$facture->hotel}} <br>
                          {{$facture->pays}} , {{$facture->hotel_adress}} <br>
                           {{$facture->email}}  <br>
                          {{$facture->tele}}
                        </td>
                        <td style="text-align: right; vertical-align:top;">
                          <span class="important-font">
                            Invoice: {{$facture->id}}<br>
                          </span>
                          {{$facture->date_start}}
                  ...
                  <tr>
                    <td style="padding-bottom: 30px;" class="mobile-padding">
                      ...
                      <table class="force-full-width" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td class="mobile-block" width="25%">
                            <table cellspacing="0" cellpadding="0" class="force-full-width">
                              ...
                              <tr>
                                <td style="background-color: #ebebeb; padding: 8px; border-top: 3px solid #ffffff;">
                                <?php echo $facture->adulte*$facture->prixuniq  ?>
                                </td>
                              </tr>
                               @if($facture->enfant >0)         
                                <tr>
                                <td style="background-color: #ebebeb; padding: 8px; border-top: 3px solid #ffffff;">
                                  <?php echo $facture->enfant*$facture->prixuniq  ?>
                                </td>
                              </tr>
                              @endif
                               @if($facture->enfant_3>0)         
                        ...
                        <tr>
                        <td colspan="4" style="background-color: #3bcdc3; color: #ffffff; padding: 5px; border-right: 3px solid #ffffff; text-align: center;"><b>Total :</b></td>
                        <td  style="background-color: #3bcdc3; color: #ffffff; padding: 5px; border-right: 3px solid #ffffff; text-align: right;">{{$facture->prixtotale}}</td>
                    </tr>
                      </table>
