                                    ...
                                    <table id="demo-foo-addrow" class="table m-t-30 table-hover contact-list" data-page-size="10">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $list->prix5_7}}</td>
                                                <td>
                                                    <a  href="{{ url('circuite/update_active/'.$list->id)}}" class="<button> </button> btn-icon btn-pure btn-outline " ><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                    <a href="url('circuit/'.$list->id.'/'.str_slug($list->titre['fr'] , '-'))}}" class="btn  btn-icon btn-pure btn-outline " ><i class="fa fa-edit" aria-hidden="true"></i></a>
                                                    <form style="display: inline ;" action="{{ url('circuit/destroyexcursions/'.$list->id)}}" method="post">
                                                    {{csrf_field()}}
                                                    {{method_field('DELETE')}}
